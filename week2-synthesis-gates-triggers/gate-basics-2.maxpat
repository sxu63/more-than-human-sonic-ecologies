...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 132.0, 325.0, 184.0, 68.0 ],
					"range" : [ -1.5, 1.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 132.0, 238.0, 184.0, 68.0 ],
					"range" : [ -1.5, 1.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.0, 164.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 187.0, 185.0, 327.0, 20.0 ],
									"text" : "we use this object to convert milliseconds to samples"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 163.5, 102.0, 259.0, 22.0 ],
									"text" : "param decay @default 10 @min 1 @max 5000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 163.5, 135.0, 70.0, 22.0 ],
									"text" : "mstosamps"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.5, 46.0, 259.0, 22.0 ],
									"text" : "param attack @default 50 @min 1 @max 5000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.5, 73.0, 70.0, 22.0 ],
									"text" : "mstosamps"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 271.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.0, 109.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.0, 164.0, 150.0, 22.0 ]
				}
